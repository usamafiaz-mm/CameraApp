...
public class MainActivity extends AppCompatActivity {
    ...
    private int REQUEST_CHECK_SETTING = 1001;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        private boolean checkAndRequestPermissions() {
            ...
            int fine = ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION);
            int coarse = ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION);
